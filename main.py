...
def video_detect(file_name, cascade_name):
    ...
    video_writer = cv2.VideoWriter('result.mp4', 0x7634706d, fps, (w, h))  # 创建视频写对象
...
if __name__ == "__main__":
    video_detect('testanime.mp4', 'lbpcascade_animeface.xml')
    video_detect('testcat.mp4', 'haarcascade_frontalcatface.xml')
